<div id="header" class="container">
    ...
    >
        <h1><a href="#">{{ $schema->header->logo_text }}</a></h1>
    </div>
    <div id="menu"
    ...
    >
        <ul>
            ...
            <li><a href="#wrapper" accesskey="2" title="">{{ $schema->content->wrapper_title }}</a></li>
            <li><a href="#welcome" accesskey="3" title="">{{ $schema->content->welcome_title }}</a></li>
            <li><a href="#contact" accesskey="4" title="">{{ $schema->content->contact_title }}</a></li>
        </ul>
    </div>
</div>
<div id="banner"
...
>
    <div class="title">
        <div class="main-text">{{ $schema->header->text }}</div>
        <span class="byline">{{ $schema->header->byline_text }}</span>
    </div>
</div>